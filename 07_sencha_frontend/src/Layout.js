...
import AddNewItems from './Home/AddNewItems';
	...
	render() {
		...
		return (
			<Container fullscreen layout="fit">
				<TitleBar title={this.title} docked="top" style={{ backgroundColor: "#e60000" }}>
				...
				{Ext.platformTags.phone ? (
					<Sheet displayed={showAppMenu} side="left" onHide={this.onHideAppMenu}>
						<Panel scrollable title="Warehouse">
				...
				<Switch>
					...
					<Route path="/addnewitems" component={AddNewItems} />
				</Switch>
			</Container>
		);
	}
